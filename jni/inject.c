...
int hook_func3(int p0,int p1,int p2,int p3,int p4,int p5,int p6,int p7,int p8,int p9,int p10,int p11,int p12,int p13,int p14,int p15,int p16,int p17,int p18,int p19)
{
    static int flag = 0;
	int (*orig_func)(int p0,int p1,int p2,int p3,int p4,int p5,int p6,int p7,int p8,int p9,int p10,int p11,int p12,int p13,int p14,int p15,int p16,int p17,int p18,int p19);
	orig_func = (void*)eph3.proto;
    //LOGD("proto: 0x%x \n", (unsigned int)(eph3.proto));
    //sleep(10);
    
    if (flag == 0)
        LOGD("func 0x%x call begin.\n", (unsigned int)(eph3.target_addr-eph3.module_base));
...
int hook_func4(int p0,int p1,int p2,int p3,int p4,int p5,int p6,int p7,int p8,int p9,int p10,int p11,int p12,int p13,int p14,int p15,int p16,int p17,int p18,int p19)
{
    static int flag = 0;
	int (*orig_func)(int p0,int p1,int p2,int p3,int p4,int p5,int p6,int p7,int p8,int p9,int p10,int p11,int p12,int p13,int p14,int p15,int p16,int p17,int p18,int p19);
	orig_func = (void*)eph4.proto;
    //LOGD("proto: 0x%x \n", (unsigned int)(eph4.proto));
    //sleep(10);
    
    if (flag == 0)
        LOGD("func 0x%x call begin.\n", (unsigned int)(eph4.target_addr-eph4.module_base));
